...
{/* <Container>
      ...
      <div textAlign='center'>Your Channel Name: {channelName}</div>
      <Form>
        <Form.Group controlId="promotionType">
          <Form.Label>Promotion Type:</Form.Label>
          <Form.Control
        ...
        <Form.Group controlId="creditsInfo">
        ...
        <Button disabled={requiredCoins > coins} variant="primary" onClick={handleClick}>
          Add Promotion
        </Button>
      </Form>
    </Container>
    <Container>
      <Card>
      <h5>How to add promotion :</h5>
              <ul>
                <li><b>STEP 1:</b> Select promotion type from above ( Youtube Likes / Subscribers etc).</li>
                <li><b>STEP 2:</b> Then you have to provide your Youtube video link or Channel ID , whatever is asked.</li>
                <li><b>STEP 3:</b> Then enter the number of likes or subscribers you want to and hit the add promotion button. Your promotion will be completed after few hours of adding the promotion.</li>
              </ul>
      </Card>
      <Card>
      <h5>Important :</h5>
              <ul>
                <li>You cannot boost same link more than one time, but you can always increase the required count by editing the promotion in view promotions page.</li>
                <li>You cannot boost any other profile or any other profile posts by using your credits.</li>
                <li>No one other than you can use your credits to get likes/subscribers on his/her account.</li>
