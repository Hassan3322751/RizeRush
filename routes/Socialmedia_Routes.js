...
router.post("/api/v1/saveYoutubeInfo", async (req, res) => {
  try {
...
router.get('/api/v1/getChannelInfo', authenticateUser, async (req, res) => {
...
router.get('/api/v1/getInstaProfInfo', authenticateUser, async (req, res) => {
...
router.post("/api/v1/saveInstaProfInfo", authenticateUser, async (req, res) => {
    try {
...
router.get('/api/v1/getTiktokProfInfo', authenticateUser, async (req, res) => {
...
router.post("/api/v1/saveTiktokProfInfo", authenticateUser, async (req, res) => {
    try {
      const { userData } = req.user;
      const data  = req.body.profileInfo;
      if (userData) {
