...
router.post("/api/v1/addPromotion", authenticateUser, async (req, res) => {
    try {
  ...
  router.get('/api/v1/getPromotions', authenticateUser, async (req, res) => {
  ...
  router.post('/api/v1/jobResult', authenticateUser, async (req, res)=>{
    const { userData } = req.user;
